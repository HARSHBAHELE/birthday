        ...
        return (
            ...
            <div className="main">
                <div className="main1">
                    ...
                    <button id='SpecialWish' onClick={this.props.start}><Link className="nav1" aria-current='page' to='/Wish'>Special Wishes</Link></button>
                    <br />
                ...
                <div className="main2">
                    ...
                    <div className="imp">
                        ...
                        <br />
                        <div className="btn">
                        <button id='SpecialWish' onClick={this.props.start1}><Link className="nav1" aria-current='page' to='/Memories'>Special Memories</Link></button>
                        </div>
                    </div>
                </div>
            </div>
